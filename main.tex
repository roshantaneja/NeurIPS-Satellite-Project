...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/types of bomas.png}
...
% \begin{figure} % Put in diagram of the model
%     \centering
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/cv_output.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.5\linewidth]{images/Outputoverlayrealmap.png}
